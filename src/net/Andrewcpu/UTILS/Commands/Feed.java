...
public class Feed implements CommandExecutor {
    ...
    {
        if (args.length == 0) {
            sender.sendMessage(ChatColor.GOLD + "Fed " + ChatColor.RED + sender.getName() + ChatColor.GOLD + ".");
            ...
            sender.sendMessage(ChatColor.GOLD + "Fed " + ChatColor.RED + p.getName() + ChatColor.GOLD + ".");
            return true;
        }
    }
}
